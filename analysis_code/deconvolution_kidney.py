...
#SBATCH -J CKD_deconvolution
#SBATCH -o CKD_deconvolution.log
#SBATCH -e CKD_deconvolution.err
#SBATCH --mem=70G
...
if get_new_model:
    ...
    ref_path = path_sn_kidney

    adata_ref = diopy.input.read_h5(file = ref_path)

    adata_ref.obs["subclass.l1"] #this would be the annotation
    ...
    cell2location.models.RegressionModel.setup_anndata(adata=adata_ref,
                                ...
                                batch_key='specimen_id', 
                                # cell type, covariate used for constructing signatures
                                labels_key='subclass.l1',
    ...
    adata_file = f"{ref_run_name}/sc_ref_CKD.h5ad"
